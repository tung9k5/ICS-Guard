...
import { Edit2, Trash2, ShieldAlert, ChevronDown, ChevronUp, Bot, Activity } from 'lucide-react';
        ...
        <table className="incident-table">
          ...
          <tbody>
            {incidents.map((incident, index) => {
              ...
              const actions = [
                { label: 'Phòng Tác Chiến War Room', icon: Activity, onClick: () => onOpenWarRoom && onOpenWarRoom(incident) },
