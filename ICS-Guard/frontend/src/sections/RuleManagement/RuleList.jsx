...
import { Edit2, Trash2, ShieldAlert, ChevronDown, ChevronUp, Play } from 'lucide-react';
import ActionMenu from '@/components/ActionMenu';
import VCheckbox from '@/components/VCheckbox';
import VNoData from '@/components/VNoData';
import { RULE_SEVERITIES, RULE_STATUSES } from '@/constants/ruleConstants';

const RuleList = ({ rules, onEdit, onDelete, onBacktest, selectedIds = [], setSelectedIds }) => {
